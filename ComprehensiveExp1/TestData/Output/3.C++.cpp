...
{
TypeCount = 6;
TypeName.push_back("关键字");
TypeName.push_back("专有符号");
TypeName.push_back("运算符");
TypeName.push_back("identifier");
TypeName.push_back("number");
TypeName.push_back("COMMENT");
vector<vector<int>> table;
table.clear();
table.push_back({166, 26, 2, 1, 4, 3, });
table.push_back({97, });
table.push_back({115, });
table.push_back({109, });
table.push_back({117, });
